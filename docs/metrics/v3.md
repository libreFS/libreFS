...
Metrics about the libreFS audit functionality.
...
Metrics about an entire libreFS cluster.
...
Metrics about the libreFS ILM functionality.
...
Metrics about libreFS logger webhooks.
...
Metrics about the libreFS notification functionality.
...
Metrics about libreFS site and bucket replication.
...
Metrics about the libreFS scanner.

| Path       | Description                           |
|------------|---------------------------------------|
| `/scanner` | Metrics related to the libreFS scanner. |
...
Metrics about the libreFS process and the node.
...
| `minio_system_process_start_time_seconds`          | Start time for libreFS process in seconds since Unix epoch. <br><br>Type: gauge                                                         | `server` |
| `minio_system_process_uptime_seconds`              | Uptime for libreFS process in seconds. <br><br>Type: gauge                                                                              | `server` |
| `minio_system_process_file_descriptor_limit_total` | Limit on total number of open file descriptors for the libreFS Server process. <br><br>Type: gauge                                      | `server` |
| `minio_system_process_file_descriptor_open_total`  | Total number of open file descriptors by the libreFS Server process. <br><br>Type: gauge                                                | `server` |
