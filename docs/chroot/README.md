# Deploy libreFS on Chrooted Environment [![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io) [![Docker Pulls](https://img.shields.io/docker/pulls/minio/minio.svg?maxAge=604800)](https://hub.docker.com/r/minio/minio/)
...
## 2. Install libreFS in Chroot

> **Note:** libreFS community edition is now distributed as source code only. Pre-compiled binaries are no longer provided for new releases.

Build libreFS from source and install it in the chroot directory:

```sh
# Build libreFS from source
...
## 3. Run Standalone libreFS in Chroot

### GNU/Linux

```sh
sudo chroot --userspec username:group /mnt/export/${USER} /bin/minio --config-dir=/.librefs server /data
...
- [libreFS Erasure Code Overview](https://docs.min.io/community/minio-object-store/operations/concepts/erasure-coding.html)
